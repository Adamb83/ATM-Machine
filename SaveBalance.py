...
balance_file = 'balance.txt'   # Define the file name for storing the balance
...
def credwithdraw():
    ...
    if choice6 > (balance):
        ...
        if choice6exit == "c":                                                                                #pass    Pass is a place holder
...
## https://github.com/Adamb83/ATM-Machine/blob/main/ATM.py    

### if name = main
## Get balance from a text file, re write to text file
